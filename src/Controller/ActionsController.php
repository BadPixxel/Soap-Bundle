...
class ActionsController extends Controller
{
     ...
     * @return Response
     */
    public function hostAction(Request $request, AbstractConnector $connector): Response
    {
        //====================================================================//
     ...
     * @return Response
     */
    public function keysAction(Request $request, AbstractConnector $connector): Response
    {
        //====================================================================//
        // Safety Check => Action Only Available in Extended Mode
        if ($connector->getParameter('Extended', false)) {
